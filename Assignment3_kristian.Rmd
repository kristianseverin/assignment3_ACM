...
```{r}
real_df <- read.csv("/Users/kristian/Documents/Skole/8. Semester/Advanced Computational Modelling/assignment3_ACM/Data/sc_df_clean.csv")
# create source 1 and get it on log-odds scale
real_df$Source1 <- real_df$FirstRating / 9  # source 1 is first rating log odds
# create source 2 and get it on log-odds scaleS
#real_df$Source2 <- abs(real_df$Feedback + real_df$Change)/ 9  # source 2 is absolute value of feedback + change log odds
# source 2 is just feedback
real_df$Source2 <- abs(real_df$Feedback) /9
