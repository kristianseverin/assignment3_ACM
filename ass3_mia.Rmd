...
b_p <- ggplot(draws_df, aes(.iteration, bias, group = .chain, color = .chain)) +
  geom_line(alpha = 0.5) +
  theme_classic()+
  theme(legend.position = "none")

sd_p <- ggplot(draws_df, aes(.iteration, sd, group = .chain, color = .chain)) +
  geom_line(alpha = 0.5) +
  theme_classic()
...
sd_p <- ggplot(draws_df, aes(.iteration, sd, group = .chain, color = .chain)) +
  geom_line(alpha = 0.5) +
  theme_classic()
w1_p <- ggplot(draws_df, aes(.iteration, w1, group = .chain, color = .chain)) +
  geom_line(alpha = 0.5) +
  theme_classic()
w2_p <- ggplot(draws_df, aes(.iteration, w2, group = .chain, color = .chain)) +
  geom_line(alpha = 0.5) +
  theme_classic()
...
ggplot(draws_df) +
  geom_density(aes(sd), alpha = 0.6, fill = "lightblue") +
  geom_density(aes(sd_prior), alpha = 0.6, fill = "pink") +
  geom_vline(xintercept = w_df$sd[1]) +
  theme_bw()
```
...
for (i in seq(6)){
  ...
  loo_list = c(loo_list, samples$loo())
